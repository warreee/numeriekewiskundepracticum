...
for i = 1:100
    ...
    % We geven 1/i mee omdat we als n al 2*i meegeven want 1-(-1)/2n = 1/n
    hexp(i) = 1/i;
...
loglog(x,averagesimpson, 'r')
loglog(x,averagequad, 'y')
loglog(x,0.00005*2.^(-log10(x)./log10(4)),'b--')
loglog(x,0.00018550469029525*2.^(-log10(x)./log10(16)),'r--')
loglog(x,0.00010237530572578*2.^(-log10(x)./log10(16)),'y--')